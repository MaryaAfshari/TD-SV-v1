...
parser.add_argument('--save_path', type=str, default="../../../../../mnt/disk1/users/afshari/MyEcapaModel2B", help='Path to save the score.txt and models')
parser.add_argument('--initial_model', type=str, default="", help='Path of the initial_model')
parser.add_argument('--path_save_model', type=str, default="../../../../../mnt/disk1/users/afshari/MyEnrollment2B", help='Path to save the enrollment and models')
